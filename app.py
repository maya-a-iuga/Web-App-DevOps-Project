...
def add_order():
    ...
    sdelivery_date = request.form['delivery_date']delivery_date = request.form['delivery_date']essiE37: No write since last change
E162: No write since last change for bufferon.commit()
