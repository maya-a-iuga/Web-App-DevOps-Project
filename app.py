...
# Key Vault details
key_vault_url = "https://AzureDevOpsProject.vault.azure.net/"
...
secret = secret_client.get_secret("server")
server = secret.value
secret = secret_client.get_secret("databse")
database = secret.value
secret = secret_client.get_secret("username")
