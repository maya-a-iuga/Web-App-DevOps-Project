...
database = secret_client.get_secret("app-database-name").value
username = secret_client.get_secret("app-server-username").value
password = secret_client.get_secret("app-server-password").value
