...
class Order(Base):
    ...
    delivery_date = Column('Delivery Date', DateTime) #adds new column 'delivery date'
...
def add_order():
    ...
    delivery_date = request.form['delivery_date'] # includes delivery date in the form
    ...
    new_order = Order(
        ...
        delivery_date=delivery_date #adds delivery date to the new order
    )
